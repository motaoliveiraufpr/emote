...
namespace ItSeez3D.AvatarSdkSamples.Core
{
	...
	public class AvatarPreview : MonoBehaviour
	{
        ...
        public TextMeshProUGUI universalStatus;
        ...
        private void Start()
        {
            ...
            {
                var uStatus = GameObject.FindGameObjectWithTag("UniversalStatus");
                if (uStatus)
                {
                    universalStatus = uStatus.GetComponent<TextMeshProUGUI>();
                }
            }
        }
		...
		public void UpdateProgress (string progressStr)
		{
            ...
            if (universalStatus != null)
            {
                universalStatus.text = progressStr;
            }
        }
